...
"[project]/apps/main/app/api/clients/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function ensureUniqueSlug(base) {
    let slug = base;
    let n = 2;
    while(await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].client.findUnique({
        where: {
            slug
        }
    })){
...
async function GET() {
    ...
    const clients = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].client.findMany({
        where: {
            isActive: true
        },
        orderBy: {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(clients.map((c)=>({
            ...c,
...
async function POST(req) {
    ...
    const client = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].client.create({
        data: {
            name: name.trim(),
            slug,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__28e67c1a._.js.map