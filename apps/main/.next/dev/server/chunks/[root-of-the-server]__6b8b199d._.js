...
"[project]/apps/main/app/api/time-entries/[entryId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req, { params }) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].timeEntry.findUnique({
        where: {
            id: entryId
        },
        select: {
    ...
    if (existing.isInvoiced) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "This entry has been invoiced and cannot be edited"
        }, {
            status: 409
        });
    }
    ...
    const entry = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].timeEntry.update({
        where: {
            id: entryId
        },
        data: {
...
async function DELETE(_req, { params }) {
    ...
    if (existing.isInvoiced) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: "This entry has been invoiced and cannot be deleted"
        }, {
            status: 409
        });
    }
    await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].timeEntry.delete({
        where: {
            id: entryId
        }
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__6b8b199d._.js.map