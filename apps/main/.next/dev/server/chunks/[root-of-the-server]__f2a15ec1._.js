...
"[project]/apps/main/app/api/clients/[clientId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_req, { params }) {
    ...
    const ticketGroups = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].ticket.groupBy({
        by: [
            "status"
        ],
        where: {
    ...
    const unbilledAgg = await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].timeEntry.aggregate({
        where: {
            clientId,
            isBillable: true,
            isInvoiced: false
...
async function PATCH(req, { params }) {
    ...
    const clientData = {
        ...
        ...contractType && VALID_CONTRACT_TYPES.includes(contractType) && {
            contractType
        },
    ...
    const client = isActive !== undefined ? await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].$transaction(async (tx)=>{
        ...
        return updated;
    }) : await __TURBOPACK__imported__module__$5b$project$5d2f$packages$2f$database$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].client.update({
        where: {
            id: clientId
        },
        data: clientData,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f2a15ec1._.js.map